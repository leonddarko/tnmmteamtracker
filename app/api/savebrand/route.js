...
export async function POST(request) {
    ...
    const { companyId, brand } = await request.json();
    ...
    try {
        ...
        console.log("Creating new brand document and for given Comapany and adding brand...");
        const newBrand = new Brand({ company: companyId, brands: [brand] });
        await newBrand.save();
